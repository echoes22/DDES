...
# DES-Net combined training: ArtEmis + D-ViSA + EmoSet → V/A regression.
# All 3 datasets contribute VA supervision (ArtEmis/D-ViSA: ground-truth VA;
# EmoSet: VA derived from emotion-centre mapping).
...
CKPT_DIR="${CKPT_DIR:-/home/ember118/links/scratch/emotion_pred/public_repl/ckpt/des_net_combined}"
LOG_DIR="${LOG_DIR:-$PROJECT_ROOT/runs/des_net_combined}"
RESUME="${RESUME:-}"
...
echo "=== DES-Net Combined Training (rrg-jlalonde, half-H100) ==="
