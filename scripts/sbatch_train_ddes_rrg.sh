...
CKPT_DIR="${CKPT_DIR:-/home/ember118/links/scratch/emotion_pred/public_repl/ckpt/ddes_unet}"
LOG_DIR="${LOG_DIR:-$PROJECT_ROOT/runs/ddes_unet}"
RESUME="${RESUME:-/home/ember118/links/scratch/emotion_pred/public_repl/ckpt/ddes_unet/best/checkpoint_epoch_002.pt}"
...
echo "=== DDES-Net Training (rrg-jlalonde, half-H100) ==="
