...
# CES-Net combined training: ArtEmis + D-ViSA + EmoSet → 8-class KL emotion dist.
...
CKPT_DIR="${CKPT_DIR:-/home/ember118/links/scratch/emotion_pred/public_repl/ckpt/ces_net_combined}"
LOG_DIR="${LOG_DIR:-$PROJECT_ROOT/runs/ces_net_combined}"
RESUME="${RESUME:-}"
...
echo "=== CES-Net Combined Training (rrg-jlalonde, half-H100) ==="
