...
CKPT_DIR="${CKPT_DIR:-/home/ember118/links/scratch/emotion_pred/public_repl/ckpt/ces_net}"
LOG_DIR="${LOG_DIR:-$PROJECT_ROOT/runs/ces_net}"
RESUME="${RESUME:-/home/ember118/links/scratch/emotion_pred/public_repl/ckpt/ces_net/best/checkpoint_epoch_001.pt}"
...
echo "=== CES-Net Training (rrg-jlalonde, half-H100) ==="
